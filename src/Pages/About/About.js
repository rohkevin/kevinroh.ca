    ...
    <main className='page-nomargin'>
        ...
        <section className="page about-container">
          <div className="max-width">
            ...
            <br/>
            <p className="body1">Fast forward to today, I've had the privilege of creating multple accessible and inclusive web applications for clients and friends. I love the unique challenges that come with each project, and every hair-pulling moment results in an absolutely rewarding outcome.</p>
            <br/>
